...
async function seed() {
  ...
  await Coupon.insertMany([
    ...
    },
    {
      ...
      perUserLimit: 1,
      audience: "all",
      applicablePaymentMethods: ["wallet", "upi"],
      stackable: false,
      validFrom: new Date(),
      validUntil: new Date(Date.now() + 90 * 86400000),
      isActive: true,
    ...
    {
      code: "BOGOWED",
      name: "Buy 1 Get 1 Wednesday",
      description: "BOGO on Wednesdays",
      discountType: "bogo",
      discountValue: 0,
      buyQuantity: 1,
      getQuantity: 1,
  ...
  await Offer.insertMany([
    {
      name: "Festival Weekend 15%",
      description: "Auto festival discount on weekends",
      kind: "festival",
      discountType: "percentage",
      discountValue: 15,
      minAmount: 300,
    ...
    {
      name: "UPI Instant 5%",
      description: "Payment-method offer for UPI",
      kind: "payment_method",
      discountType: "percentage",
      discountValue: 5,
      minAmount: 200,
    ...
    },
    {
      ...
      description: "Show-time offer 10am-2pm",
      kind: "show_time",
      discountType: "fixed",
      discountValue: 50,
      minAmount: 150,
      ...
      priority: 20,
      audience: "all",
      applicableTimeSlots: ["10:00-14:00"],
      validFrom: new Date(),
      validUntil: new Date(Date.now() + 90 * 86400000),
      isActive: true,
    },
